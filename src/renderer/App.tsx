...
const App: React.FC = () => {
  ...
  const [quickUseInitialPlatform, setQuickUseInitialPlatform] = useState<'xhs' | 'x' | 'binance' | 'bitget' | 'bybit' | 'gate' | 'youtube' | 'tiktok' | 'douyin' | 'kuaishou' | 'bilibili' | 'shipinhao' | 'toutiao' | 'instagram' | 'facebook' | 'reddit' | 'video' | undefined>(undefined);
  ...
  const handleShowScenarioCreate = (platform?: 'xhs' | 'x' | 'binance' | 'bitget' | 'bybit' | 'gate' | 'youtube' | 'tiktok' | 'douyin' | 'kuaishou' | 'bilibili' | 'shipinhao' | 'toutiao' | 'instagram' | 'facebook' | 'reddit' | 'video') => {
